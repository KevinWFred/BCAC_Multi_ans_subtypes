...
#swarm -f /data/BB_Bioinformatics/Kevin/BCAC/code/euro_onco_geno.swarm -g 32   --time 0:20:00 --gres=lscratch:16 -b 250
#swarm -f /data/BB_Bioinformatics/Kevin/BCAC/code/euro_icogs_geno.swarm -g 32   --time 0:20:00 --gres=lscratch:16 -b 250
