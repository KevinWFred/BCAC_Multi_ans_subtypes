...
plink2=/usr/local/apps/plink/3.6-alpha/plink2
  ...
  do
    ...
    then
      ...
      do
        ...
        $plink2 --bgen ${infolder}${prefix}${chr}_p${seg}.bgen ref-unknown --sample ${infolder}${prefix}1_p1.sample --oxford-single-chr ${chr} --keep ${infolder}${prefix}plinksamples.txt --pheno ${infolder}${prefix}pheno.txt --make-pgen --out ${outfolder}${outprefix}_chr.${chr}.${seg} --memory 300000 --threads 45
        echo ${outfolder}${outprefix}_chr.${chr}.${seg} >> ${outfolder}${outprefix}_mergelist.txt
      done
    else #no segments
      if [ -f ${infolder}${prefix}1_p1.sample ]
      then
        ...
        $plink2 --bgen ${infolder}${prefix}${chr}.bgen ref-unknown --sample ${infolder}${prefix}1_p1.sample --oxford-single-chr ${chr} --maf 0.005 --keep ${infolder}${prefix}plinksamples.txt --pheno ${infolder}${prefix}pheno.txt --make-pgen --out ${outfolder}${outprefix}_chr.${chr} --memory 300000 --threads 45
      else
        ...
        $plink2 --bgen ${infolder}${prefix}${chr}.bgen ref-unknown --sample ${infolder}${prefix}1.sample --oxford-single-chr ${chr} --maf 0.005 --keep ${infolder}${prefix}plinksamples.txt --pheno ${infolder}${prefix}pheno.txt --make-pgen --out ${outfolder}${outprefix}_chr.${chr} --memory 300000 --threads 45
      fi  
